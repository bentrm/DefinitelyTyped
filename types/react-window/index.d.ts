...
export interface ListChildComponentProps<T = undefined> {
    index: number;
    style: CSSProperties;
    data: T;
    isScrolling?: boolean;
...
export interface GridChildComponentProps<T = undefined> {
    columnIndex: number;
    rowIndex: number;
    style: CSSProperties;
    data: T;
...
export interface FixedSizeListProps<T = undefined> extends ListProps<T> {
    /**
...
export interface VariableSizeListProps<T = undefined> extends ListProps<T> {
    /**
...
export interface FixedSizeGridProps<T = undefined> extends GridProps<T> {
    /**
...
export interface VariableSizeGridProps<T = undefined> extends GridProps<T> {
    /**
...
export class FixedSizeList<T = undefined> extends Component<FixedSizeListProps<T>> {
    /**
...
export class VariableSizeList<T = undefined> extends Component<VariableSizeListProps<T>> {
    /**
     * Scroll to the specified offset (scrollTop or scrollLeft, depending on the direction prop).
     */
    scrollTo(scrollOffset: number): void;
...
export class FixedSizeGrid<T = undefined> extends Component<FixedSizeGridProps<T>> {
    /**
...
export class VariableSizeGrid<T = undefined> extends Component<VariableSizeGridProps<T>> {
    /**
     * Scroll to the specified offsets.
     */
    scrollTo(params: { scrollLeft: number; scrollTop: number }): void;
